...
namespace ProjectCars.Models
{
    public class MockCarRepository : ICarRepository
    {
        ...
        private void LoadCars()
        {
            cars = new List<Car>
            {
                new Car { Id = 1, Make = "BMW", Model = "M3", YearOfProduction = 2018, Mileage = "1 000 km", Engine = "4 900 cm3", Fuel = "benzyna", HorsePower = "421 KM", Description = "Mam do sprzedania BMW M3", Price = 160000M, PhotoUrl = "/images/.bmwM3.jpg", MiniPhotoUrl = "/images/bmwM3.jpg"},
